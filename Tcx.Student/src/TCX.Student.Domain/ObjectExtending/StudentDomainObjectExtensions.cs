...
namespace TCX.Student.ObjectExtending
{
    public static class StudentDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the StudentEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
