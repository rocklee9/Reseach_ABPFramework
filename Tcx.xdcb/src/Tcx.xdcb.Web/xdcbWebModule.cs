...
using Tcx.xdcb.MultiTenancy;
using Tcx.xdcb.Web.Menus;
    ...
    public class xdcbWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<xdcbDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Tcx.xdcb.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<xdcbDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Tcx.xdcb.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<xdcbApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Tcx.xdcb.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<xdcbApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Tcx.xdcb.Application"));
