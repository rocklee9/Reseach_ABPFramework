...
namespace Tcx.xdcb.ObjectExtending
{
    public static class xdcbDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the xdcbEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
