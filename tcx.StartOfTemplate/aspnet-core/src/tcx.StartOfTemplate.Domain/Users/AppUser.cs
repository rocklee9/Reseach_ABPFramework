...
namespace tcx.StartOfTemplate.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update StartOfTemplateDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update StartOfTemplateEfCoreEntityExtensionMappings to extend the IdentityUser entity
